...
<%@ page import="fit.yujing.utils.CookieUtil" %>
...
<body>
<%
  pageContext.setAttribute("cookie_stuCode",CookieUtil.getCookie(request,"cookie_stuCode"));
  pageContext.setAttribute("cookie_pwd",CookieUtil.getCookie(request,"cookie_pwd"));
%>
<div class="container">
      <form name="myForm" class="form-signin" action="${pageContext.request.contextPath}/login" method="post" onsubmit="return checkForm()">
        ...
        <input id="stuCode" name="stuCode" value="${cookie_stuCode}" type="text" class="input-block-level" placeholder="学号...">
        <input id="password" name="password" value="${cookie_pwd}" type="password" class="input-block-level" placeholder="密码..." >
		...
		<p align="center" style="padding-top: 15px;">@CopyRight 2023 HBNU-Tiam</p>
      </form>
</div>
</body>
</html>